<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="成交价" prop="make_order_date" width="100px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('order.yh_fee')" prop="make_order_date" width="100px" align="center">
        <template slot-scope="scope">
