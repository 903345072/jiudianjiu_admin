<template>
  <div class="app-container">
    ...
    >
      <el-table-column :label="$t('table.id')" prop="id" align="center" width="150px">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.nickname')" prop="make_order_date" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.member.nickname }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.dl_name')" prop="make_order_date" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.member.p_admin.username }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.contract_no')" prop="make_order_date" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.contract_no }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.stock_code')" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.stock_code }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.stock_name')" width="200px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.stock_name }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.member_id')" prop="make_order_date" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.member_id }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.make_order_date')" prop="make_order_date" width="220px" align="center" sortable="custom" :class-name="getSortClass('make_order_date')">
        <template slot-scope="scope">
          <span>{{ scope.row.make_order_date }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.buy_price')" prop="make_order_date" width="100px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('order.buy_hand')" prop="make_order_date" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.buy_hand }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.stock_status')" prop="make_order_date" min-width="150px" align="center">
        <template slot-scope="scope">
