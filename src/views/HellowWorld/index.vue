<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="邀请码" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.invite_code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="手续费" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.sx_rate }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="手续费" prop="passwd">
          <el-input v-model="temp.sx_rate" />
        </el-form-item>
